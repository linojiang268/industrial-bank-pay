...
namespace Ouarea\Payment\IndustrialBank;
...
class Service
{
    ...
    public function __construct(array $config, ClientInterface $client = null)
    {
        ...
        $this->version    = array_get($config, 'version', '1.0');
     ...
     *                              - services    available values are: pay.weixin.jspay|pay.weixin.micropay|pay.weixin.native|pay.weixin.app
    ...
    private function postUnifiedOrderRequestAndParse($params)
    {
        ...
        if ($xml->status == 0) {
            ...
            $result->code = 0;
            $result->services = (string) $xml->services;
